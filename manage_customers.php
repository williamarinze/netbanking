            ...
            <div class="flex-item-search-bar" id="fi-search-bar">
                ...
                <form class="search_form" action="" method="post">
                    <div class="flex-item-search">
                        <input style="height: 56px; padding: 9px; font-family: courier;" name="search" size="30" type="text" placeholder="Search Customers..." />
                    </div>
                    ...
                    <div class="flex-item-by">
                        <label style="height: 56px; font-family: courier;">By :</label>
                    </div>

                    <div class="flex-item-search-by">
                        <select name="by" style="font-family: courier;">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class="flex-item" >
                    ...
                    <div class="flex-item-2">
                        <p id="name" style="font-family: cursive;"><?php echo $row["first_name"] . " " . $row["last_name"]; ?></p><br>
