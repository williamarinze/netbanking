...
<body>
    <div class="search-bar-wrapper">
        <div class="search-bar" id="the-search-bar">
            <div class="flex-item-search-bar" id="fi-search-bar">
                <a class="add-button btn" href="add_beneficiary.php" style="height: 55px;">Add</a>

                <form class="search_form" action="" method="post">
                    <div class="flex-item-search">
                        <input style="padding: 8px;"  name="search" type="text" placeholder="Search Beneficiaries..." />
                    </div>
                    ...
                    <div class="flex-item-by">
                        <label style="height: 56px;" for="by">By :</label>
                    </div>
    ...
    <div class="flex-container">
        <p id="info" style="font-family: courier;">Manage Beneficiaries.</p>
        <?php
                ...
                ?>
                    ...
                    <div class="flex-item">
                        ...
                        <div class="flex-item-2">
                            <p id="name"><?php echo $row1["first_name"] . " " . $row1["last_name"]; ?></p><br>
