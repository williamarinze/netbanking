...
<body>
    <div class="sidenav" id="theSideNav">
        ...
        <a style="font-family: Trebuchet MS;" href="customer_home.php">Home</a>
        <a style="font-family: Trebuchet MS;" href="customer_transactions.php">Transaction History</a>
        <a style="font-family: Trebuchet MS;" href="beneficiary.php">Beneficiaries</a> 
        <a id="label">Transactions</a>
        <a style="font-family: Trebuchet MS;" href="add_beneficiary.php">Transfer Funds</a>
        <a style="font-family: Trebuchet MS;" href="atm_simulator.php">ATM Simulator</a>
        <a id="label">My Profile</a>
        <a style="font-family: Trebuchet MS;" href="customer_profile.php">Edit Profile</a>
        <a style="font-family: Trebuchet MS;" href="pass_change.php">Change Password</a>        
        <a style="font-family: Trebuchet MS;" href="logout_action.php" onclick="return confirm('Are you sure?')">Log out</a>       
    </div>
