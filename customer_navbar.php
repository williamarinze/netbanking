...
<body>
    <div class="nav-wrapper">
        <div class="topnav" id="theTopNav" style="background-color:#454545;">
            <a href="javascript:void(0);" class="icon" onclick="openNav()" id="hamburger">
                &#9776;
            </a>
            <a id="user" style="font-family: cursive;color: antiquewhite;">Welcome, &nbsp<?php echo $row["first_name"]; ?> </a>
            <a id="logout" href="logout_action.php" onclick="return confirm('Are you sure?')">Logout</a>
            <a id="profile" href="customer_profile.php">Edit Profile</a>
        </div>
    </div>
